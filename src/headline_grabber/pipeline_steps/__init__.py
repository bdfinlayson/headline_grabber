...
subject_classification_model = AutoModelForSequenceClassification.from_pretrained(
    "textattack/bert-base-uncased-ag-news"
)
...
text_summarization_model = AutoModelForSeq2SeqLM.from_pretrained(
    "facebook/bart-large-cnn"
)

# Load the headline generator model and tokenizer
headline_model = T5ForConditionalGeneration.from_pretrained(
